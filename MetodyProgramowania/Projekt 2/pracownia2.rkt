...
(define (gate-not output input)
  (wire-on-change! input (lambda () (saa (wire-simulation input) 1 (lambda ( ) (wire-set! output (not (wire-value_wire input))))))))

;[gate-and  (-> wire? wire? wire? void?)]
(define (gate-and output input-a input-b)
  (wire-on-change! input-a (lambda () (saa (wire-simulation input-a) 1 (lambda () (wire-set! output (and (wire-value_wire input-a) (wire-value_wire input-b)))))))
  (wire-on-change! input-b (lambda () (saa (wire-simulation input-b) 1 (lambda () (wire-set! output (and (wire-value_wire input-a) (wire-value_wire input-b))))))))

;[gate-nand (-> wire? wire? wire? void?)]
(define (gate-nand output input-a input-b)
  (wire-on-change! input-a (lambda () (saa (wire-simulation input-a) 1 (lambda () (wire-set! output (not (and (wire-value_wire input-a) (wire-value_wire input-b))))))))
  (wire-on-change! input-b (lambda () (saa (wire-simulation input-b) 1 (lambda () (wire-set! output (not (and (wire-value_wire input-a) (wire-value_wire input-b)))))))))

;[gate-or   (-> wire? wire? wire? void?)]
(define (gate-or output input-a input-b)
  (wire-on-change! input-a (lambda () (saa (wire-simulation input-a) 1 (lambda () (wire-set! output (or (wire-value_wire input-a) (wire-value_wire input-b)))))))
  (wire-on-change! input-b (lambda () (saa (wire-simulation input-b) 1 (lambda () (wire-set! output (or (wire-value_wire input-a) (wire-value_wire input-b))))))))

;[gate-nor  (-> wire? wire? wire? void?)]
(define (gate-nor output input-a input-b)
  (wire-on-change! input-a (lambda () (saa (wire-simulation input-a) 1 (lambda () (wire-set! output (not (or (wire-value_wire input-a) (wire-value_wire input-b))))))))
  (wire-on-change! input-b (lambda () (saa (wire-simulation input-b) 1 (lambda () (wire-set! output (not (or (wire-value_wire input-a) (wire-value_wire input-b)))))))))

;[gate-xor  (-> wire? wire? wire? void?)]
(define (gate-xor output input-a input-b)
  (wire-on-change! input-a (lambda () (saa (wire-simulation input-a) 2 (lambda () (wire-set! output (if (equal? (wire-value_wire input-a) (wire-value_wire input-b)) #f #t))))))
  (wire-on-change! input-b (lambda () (saa (wire-simulation input-b) 2 (lambda () (wire-set! output (if (equal? (wire-value_wire input-a) (wire-value_wire input-b)) #f #t)))))))
