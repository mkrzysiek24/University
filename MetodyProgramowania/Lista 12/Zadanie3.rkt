...
(define (apply [v1 : Value] [v2 : Value] [env_a : Env]) : Value
  (type-case Value v1
    [(funV x b)
     (eval b (extend-env env_a x v2))]
    [(primopV f)
     (f v2)]
...
;zmienne są wiązane w momencie ich użycia, więc nie ma potrzeby deklarowania ich wcześniej za pomocą letrec.